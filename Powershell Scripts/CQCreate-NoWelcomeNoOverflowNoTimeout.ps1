...
#Write-Host "Adding random unassigned phone number to Call Queue. Script will pause for 4 minutes before executing assignment to allow resource account licence allocation" -ForegroundColor Green
